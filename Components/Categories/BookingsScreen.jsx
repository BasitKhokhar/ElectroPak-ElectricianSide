...
//         {
//           options: [...statuses, 'Cancel'],
//           cancelButtonIndex: statuses.length,
//         },
//         (buttonIndex) => {
...
//       <Text style={styles.name}>Client Name: {item.name}</Text>
...
//       <TouchableOpacity style={styles.button} onPress={() => handleCheckLocation(item.latitude, item.longitude)}>
//         <Text style={styles.buttonText}>Check Location</Text>
//       </TouchableOpacity>

//       <TouchableOpacity style={styles.statusButton} onPress={() => showStatusPicker(item.id)}>
...
//       </MapView>
//       <Text style={styles.heading}>All Booking Requests</Text>
//       {loading ? (
//         <ActivityIndicator size="large" color="#FFD700" />
//       ) : bookings.length === 0 ? (
//         <Text style={styles.noBookings}>No bookings found</Text>
//       ) : (
//         <FlatList data={bookings} keyExtractor={(item) => item.id.toString()} renderItem={renderItem} />
//       )}
//     </View>
//   );
// };
...
//     marginBottom: 10,
//   },
//   heading:{color:'white',fontSize:20,fontWeight:'bold',textAlign:'center',marginVertical:10},
//   bookingItem: {
