...
//       const fileRef = ref(storage, `TechniciansprofileImages/${userId}.jpg`);
...
//   text: { fontSize: 18, marginVertical: 5, color: "#999" },
//   uploadButton: { backgroundColor: "#007BFF", paddingVertical: 10, paddingHorizontal: 20, borderRadius: 5, marginVertical: 20 },
...
const AccountDetailScreen = ({ route }) => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.bodybackground }]}>
      <Text style={[styles.title, { color: colors.primary }]}>Account Details</Text>
 ...
 <TouchableOpacity
          ...
          disabled={uploading}
        >
          {uploading ? <ActivityIndicator size="small" color="#FFF" /> : <Text style={styles.buttonText}>Upload Profile Image</Text>}
        </TouchableOpacity>
        <TouchableOpacity
          ...
          disabled={updating}
        >
          {updating ? <ActivityIndicator size="small" color="#FFF" /> : <Text style={styles.buttonText}>Update Details</Text>}
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  formContainer: { marginTop: 10, gap: 15 },
  input: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 15, paddingVertical: 12, fontSize: 16 },
  button: { paddingVertical: 14, borderRadius: 10, marginTop: 10 },
